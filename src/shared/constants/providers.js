...
export const FREE_TIER_PROVIDERS = {
  ...
  canopywave: { id: "canopywave", alias: "cwv", name: "CanopyWave", icon: "cloud", color: "#15B8A6", textIcon: "CW", website: "https://canopywave.com", notice: { text: "Free-tier OpenAI-compatible inference endpoint. Supports MiMo and Kimi models.", apiKeyUrl: "https://canopywave.com" }, serviceKinds: ["llm"] },
